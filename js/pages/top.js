const lyTop = {
                ...
                <div class='py-container'>
                    <div class='yui3-g Logo'>
                        <div class='yui3-u Left logoArea'>
                            <a class='logo-bd' title='浪淘淘' href='/index.html' target='_blank'></a>
                        </div>
                            ...
                            <div class='search'>
                                <div action='' class='sui-form form-inline'>
                                    ...
                                    <div class='input-append'>
                                        ...
                                        <button @click='search' class='sui-btn btn-xlarge btn-danger' type='button'>搜索
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    methods: {
        ...
        loadItemNum() {
            this.isLogin()
                .then(
                    ly.http.get("/cart/loadItemNum").then(resp => {
                        this.itemNum = resp.data;
                    }).catch()
                ).catch(
                this.itemNum = ly.store.get("carts").length
            )
        }
        ,
        search() {
